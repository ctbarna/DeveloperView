<?php 
/**
 * PHProxy include file for displaying errors
 *
 * Used primarily in developer view when user attempts to visit website out of domain whitelist
 * 
 * @package PHProxy
 */
...
<head>
  <title>FCC Proxy</title>
  <link rel="stylesheet" type="text/css" href="css/phproxy.css" title="Default Theme" media="all" />
</head>
            ...
            case 'url':
                ...
                switch ($data['type'])
                {
                    ...
                    case 'external':
                        ...
                        {
                            case 1:
                                $message = 'You may only visit URLs on the domain FCC.gov. Please try another URL.';
                                break;
                            case 2:
...
?>
  ...
  <div id="footer">Adapted From <a href="http://whitefyre.com/poxy/">PHProxy</a> <?php echo $GLOBALS['_version'] ?></div>
</div>
</body>
</html>